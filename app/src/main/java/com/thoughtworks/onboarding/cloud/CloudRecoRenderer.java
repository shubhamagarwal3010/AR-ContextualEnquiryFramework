...
*/
    ...
    public void renderFrame(State state, float[] projectionMatrix) {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            // TODO: Enable this for mapping image targets from local assets
            // renderCorrespondingImage(projectionMatrix, trackable, result.getPose());
    ...
    /*private void renderCorrespondingImage(float[] projectionMatrix, Trackable trackable, Matrix34F matrix34F) {
        Matrix44F modelViewMatrix_Vuforia = Tool.convertPose2GLMatrix(matrix34F);
        float[] modelViewMatrix = modelViewMatrix_Vuforia.getData();
